...
// /about, /experience, /contact et /formations ne sont pas listées : ce sont
// des redirections vers les ancres de la home (architecture « vitrine à
// ancres »), Google les marquerait « page avec redirection » sans les indexer.
