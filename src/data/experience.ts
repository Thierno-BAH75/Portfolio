...
export const experiences: Experience[] = [
  {
    ...
    achievements: {
      fr: [
        "Déploiement d'une infrastructure réseau de production : 1 salle serveur, 2 baies, ~10 serveurs Dell, câblage et brassage complets",
        "Supervision centralisée Zabbix sur 100 % de l'infrastructure : ~10 alertes critiques, suivi et optimisation CPU/RAM/disque",
        "Segmentation en 6+ VLANs avec routage inter-VLAN, administration LAN / Wi-Fi / VPN, haute disponibilité (stacks de switchs, LAG)",
        ...
        "Bastion d'accès sécurisé Apache Guacamole (PAM) et impression sécurisée par badge NFC intégrée à l'Active Directory",
        "Configuration switchs, pare-feu, serveurs et NAS ; maquettes d'infrastructure client et documentation technique exploitable",
      ],
      en: [
        "Deployed a production network infrastructure: 1 server room, 2 racks, ~10 Dell servers, full cabling and patching",
        "Centralized Zabbix monitoring across 100% of the infrastructure: ~10 critical alerts, CPU/RAM/disk tracking and optimization",
        "Segmented the network into 6+ VLANs with inter-VLAN routing; LAN / Wi-Fi / VPN administration with high availability (switch stacks, LAG)",
        "Administered 2 hypervisors (Proxmox, Hyper-V): ~30 VMs in operation, RAID storage, hosting business-critical internal services",
        "Deployed an Apache Guacamole secure access bastion (PAM) and NFC badge-release printing integrated with Active Directory",
        "Configured switches, firewalls, servers and NAS; built client infrastructure mock-ups and actionable technical documentation",
      ],
    },
  ...
  },
  {
    ...
    achievements: {
      fr: [
        ...
        "Support N1 à N3 pour ~500 utilisateurs en environnement critique, sur site et à distance (Clarilog, DameWare)",
        "Administration Active Directory & Exchange : comptes, messageries, lecteurs réseau, GPO d'automatisation et de sécurisation des postes",
        "Administration des switchs Aruba et pare-feu Fortinet : VLANs, règles de filtrage, accès VPN",
        "Gestion d'un parc de plusieurs centaines d'équipements : SCCM, création et maintenance d'images masters, inventaire Clarilog",
        "Virtualisation Hyper-V, téléphonie utilisateurs, formations et accompagnement des équipes",
      ],
      en: [
        ...
        "Delivered L1–L3 support for ~500 users in a critical environment, on-site and remotely (Clarilog, DameWare)",
        "Administered Active Directory & Exchange: accounts, mailboxes, network drives, GPOs for workstation automation and hardening",
        "Administered Aruba switches and Fortinet firewalls: VLANs, filtering rules, VPN access",
        "Managed a fleet of several hundred devices: SCCM, master image creation and maintenance, Clarilog inventory",
        "Hyper-V virtualization, user telephony, staff training and team support",
      ],
    },
