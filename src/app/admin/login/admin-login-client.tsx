...
export default function AdminLoginClient({ socialLinks }: { socialLinks: SocialLink[] }) {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background pt-20">
      ...
      {/* Barre du haut : retour au site à gauche, réseaux + thème à droite —
          /admin/* n'a ni header ni sidebar tant que l'utilisateur n'est pas
          connecté, ces liens étaient sinon totalement inaccessibles ici. */}
        ...
        <div className="flex items-center gap-3">
          {socialLinks
            ...
            .map((social) => (
              ...
              >
                {social.icon === "github" ? <Github size={16} /> : <Linkedin size={16} />}
              </a>
            ))}
          <ThemeToggle />
        </div>
